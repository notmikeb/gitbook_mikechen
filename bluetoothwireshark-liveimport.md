## Live import raw hci buffer data to wireshark

Sample file
https://wiki.wireshark.org/SampleCaptures
**Download a file and save it as l2capcfa.log**

**Run it with wireshark.exe's filepath**

Dependence
**Need win32pip & win32file**
